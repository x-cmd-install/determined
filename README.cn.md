...
[![x-cmd/install — determined Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/determined.svg?lang=zh)](https://x-cmd.com/install/determined)

## 安装

```sh
x install determined
```

## 代码洞察

合计: **574,843** 行代码（覆盖前 5 种语言、共 **2236** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 249,139 | 18,257 | 36,887 | 868 |
| Python | 105,262 | 4,961 | 17,851 | 581 |
| Tsx | 53,883 | 827 | 5,444 | 351 |
| Json | 46,146 | 0 | 79 | 129 |
| TypeScript | 45,658 | 21,862 | 5,192 | 307 |
...
- **上游仓库**: <https://github.com/determined-ai/determined>
- **官网**: <https://determined.ai>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.38.1` (2025-03-19)
- **最近提交**: 2025-03-20
- **Release 含资产**: 19 个

## 流行度

- **Star**: 3,239 · **Fork**: 375 · **开放 issue**: 395 · **贡献者**: 95

## 累计统计

- **发布数**: 121 · **已合并 PR**: 8379 · **开放 PR**: 63 · **已关闭 issue**: 350 · **开放 issue**: 45 · **提交数**: 8394
...
| 360d | 2025-09-29 | 0 | 0 | 2 | 0 | 4 | 0 |
| last720d | 2024-10-04 | 5 | 174 | 27 | 2 | 9 | 151 |
...
determined 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `determined` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/determined.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T03:29:28Z._
